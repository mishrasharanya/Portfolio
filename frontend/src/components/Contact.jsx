...
const Contact = () => {
  ...
  return (
    <section id="contact" ref={ref} className="py-16 md:py-24 bg-[#0A0A0A]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
            Interested in building at the intersection of Data Science, AI, Optimization, and Intelligent Systems.
            Always open to opportunities, collaborations, and impactful projects.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="bg-white/5 border border-white/10 p-4 sm:p-6 hover:border-cyan-400/50 transition-all duration-300 group">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                <div className="p-3 bg-cyan-400/10 border border-cyan-400/30 group-hover:bg-cyan-400 transition-all duration-300 w-fit mx-auto sm:mx-0">
                ...
                <div className="flex-1 text-center sm:text-left min-w-0">
                  ...
                  <a
                    ...
                    className="text-base sm:text-lg text-white hover:text-cyan-400 transition-colors font-medium break-words"
                  >
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2 bg-white/5 border border-white/10 hover:bg-cyan-400 hover:text-black hover:border-cyan-400 transition-all duration-300 text-sm font-medium"
                >
                  {copied ? 'Copied!' : 'Copy'}
                </button>
              </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-gradient-to-br from-cyan-400/20 to-transparent border border-cyan-400/30 p-5 sm:p-8 lg:p-12 text-center lg:text-left">
              <img
                src="https://images.pexels.com/photos/8849295/pexels-photo-8849295.jpeg"
                alt="AI Brain Concept"
                className="w-full h-48 sm:h-64 object-cover mb-6 border-2 border-cyan-400/30"
              />

              <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">Download My Resume</h3>
              ...
              <a
                href="/Sharanya_Mishra_Resume.pdf"
