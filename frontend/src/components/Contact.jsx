      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Interested in building at the intersection of Data Science, AI, Optimization, and Intelligent Systems. Always open to opportunities, collaborations, and impactful projects.
          </p>
        </motion.div>
